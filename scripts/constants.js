...
export const MARGALET = new StellarSdk.Asset('MARGALET', 'GA5PB5WXXE4GTJWCDOPJPACFO7KC5IIIOO356XUCP37JPRDHJ2DL4AFI');
export const NOZAMA = new StellarSdk.Asset('NOZAMA', 'GDVA6YXBBNA7ONRYIWQDVSZC366EU5HQIBKPY4PNM4QBVSDJCKYMF2EE');
export const AllAssets = [QADSAN, MARGALET, NOZAMA, ELGOOG, ASIV, LAPYAP, EKIN, EKOOBECAF, TFOSORCIM, ELPPA, ISPEP, ALSET];
